...
@section('title', 'បង្កើត Course')

@section('content')
    <section class="content-header mt-4 px-0">
        <div class="container-fluid px-0">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-7"><h1>បង្កើត Course</h1></div>
                <div class="col-sm-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header"><h3 class="card-title mb-0">ព័ត៌មាន Course</h3></div>
        <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" class="form-control custom-select @error('category_id') is-invalid @enderror" required>
                                ...
                                @foreach ($courseCategories as $courseCategory)
                                    <option value="{{ $courseCategory->id }}" @selected(old('category_id') == $courseCategory->id)>
                                        {{ $courseCategory->name }}
                                    </option>
                                @endforeach
                            </select>
