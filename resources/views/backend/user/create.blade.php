...
@section('title', 'បង្កើតអ្នកប្រើ')

@section('content')
    <section class="content-header mt-4 px-0">
        <div class="container-fluid px-0">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-7"><h1>បង្កើតអ្នកប្រើ</h1></div>
                <div class="col-sm-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header"><h3 class="card-title mb-0">ព័ត៌មានអ្នកប្រើ</h3></div>
        <div class="card-body">
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                                value="{{ old('username') }}" maxlength="100" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>បញ្ជាក់ Password <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" name="roles[]" value="{{ $role->role_id }}"
                                            ...
                                            @checked(in_array($role->role_id, old('roles', [])))>
